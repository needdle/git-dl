...
_ELEMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='line', full_name='fast.Element.line', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='column', full_name='fast.Element.column', index=7,
